...
var Slider = {
    ...
    methods: {
        ...
        getIndex: function(index$$1, prev) {
            ...
            return uikitUtil.clamp(uikitUtil.getIndex(index$$1, this.slides, prev, this.finite), 0, this.maxIndex);
        },
...
function triggerUpdate(el, type, data$$1) {
    uikitUtil.trigger(el, uikitUtil.createEvent(type, false, false, data$$1));
}
...
var Component = {
    ...
    update: {
        ...
        write: function() {
            ...
            uikitUtil.$$(("[" + (this.attrItem) + "],[data-" + (this.attrItem) + "]"), this.$el).forEach(function (el) {
                var index$$1 = uikitUtil.data(el, this$1.attrItem);
                this$1.maxIndex && uikitUtil.toggleClass(el, 'uk-hidden', uikitUtil.isNumeric(index$$1) && (this$1.sets && !uikitUtil.includes(this$1.sets, uikitUtil.toFloat(index$$1)) || index$$1 > this$1.maxIndex));
            });
    ...
    methods: {
        ...
        reorder: function() {
            ...
            this.slides.forEach(function (slide, i) { return uikitUtil.css(slide, 'order', this$1.dir > 0 && i < index$$1
                    ? 1
            ...
            while (width > 0) {
                ...
                uikitUtil.css(slide, 'order', slideIndex > index$$1 ? -2 : -1);
        ...
        getValidIndex: function(index$$1, prevIndex) {
            ...
            do {
                ...
                if (uikitUtil.includes(this$1.sets, index$$1)) {
                    return index$$1;
                }
