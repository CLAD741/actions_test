...
function stateAPI (UIkit) {
    ...
    function normalizeData(ref, ref$1) {
        ...
        data$$1 = isArray(data$$1)
            ? args && args.length
                ? data$$1.slice(0, args.length).reduce(function (data$$1, value, index) {
...
function getPlaceholderImage(width, height, sizes, color) {
    ...
    if (sizes) {
        ...
        var assign;
        ((assign = Dimensions.ratio({width: width, height: height}, 'width', toPx(matches || '100vw')), width = assign.width, height = assign.height));
...
var Animations = assign({}, Animations$1, {
...
var LightboxPanel = {
    ...
    mixins: [Container, Modal$1, Togglable, Slideshow],
...
var Lightbox = {
    ...
    update: function(data) {
        ...
        if (!this.panel || isEqualList$1(data.toggles, this.toggles)) {
            return;
        }
...
var Animations$2 = assign({}, Animations$1, {
...
UIkit$2.component('countdown', Countdown);
UIkit$2.component('filter', Filter);
UIkit$2.component('lightbox', Lightbox);
UIkit$2.component('lightboxPanel', LightboxPanel);
UIkit$2.component('notification', Notification);
UIkit$2.component('parallax', Parallax);
UIkit$2.component('slider', Slider$1);
UIkit$2.component('sliderParallax', SliderParallax);
UIkit$2.component('slideshow', Slideshow$1);
UIkit$2.component('slideshowParallax', SliderParallax);
UIkit$2.component('sortable', Sortable);
UIkit$2.component('tooltip', Tooltip);
UIkit$2.component('upload', Upload);
