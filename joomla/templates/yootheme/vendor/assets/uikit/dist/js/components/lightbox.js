            ...
            handler: function(_, item) {
                ...
                if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i)) {
                    ...
                    var setIframe = function (width$$1, height$$1) {
                        ...
                        return this$1.setItem(item, getIframe(("https://www.youtube" + (matches[1] || '') + ".com/embed/" + id), width$$1, height$$1, this$1.videoAutoplay));
                    };
                    ...
                    uikitUtil.ajax(("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + (encodeURI(source))), {responseType: 'json', withCredentials: false})
                        .then(
                            function (ref) {
                                ...
                                return this$1.setItem(item, getIframe(("https://player.vimeo.com/video/" + (matches[2])), width$$1, height$$1, this$1.videoAutoplay));
                    },
                            function () { return this$1.setError(item); }
                        );
...
var Component = {
    ...
    update: function(data$$1) {
        ...
        if (!this.panel || isEqualList(data$$1.toggles, this.toggles)) {
            return;
        }
            ...
            return this.panel = this.panel || this.$create('lightboxPanel', uikitUtil.assign({}, this.$props, {
                items: this.toggles.reduce(function (items, el) {
                    items.push(['href', 'caption', 'type', 'poster', 'alt'].reduce(function (obj, attr$$1) {
                        obj[attr$$1 === 'href' ? 'source' : attr$$1] = uikitUtil.data(el, attr$$1);
                        return obj;
                    }, {}));
                    return items;
                }, [])
