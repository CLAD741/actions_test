...
class FotosModelPerfils extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters
		$params = JComponentHelper::getParams('com_fotos');
	...
	protected function getListQuery()
	{
		...
		$query->select('a.ext, a.imagen, a.cita, a.datos');
      ...
      'a.nombre',
		...
		if (!empty($searchWord))
		{
			...
			else
			{
				...
				$query = FotosHelpersBackend::buildSearchQuery($searchWord, $searchColumns, $query);
			}
		}
