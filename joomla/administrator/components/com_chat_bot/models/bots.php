 ...
 * Chat_bot model
 */
class Chat_botModelBots extends JModelList
{
	/**
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters
		$params = JComponentHelper::getParams('com_chat_bot');
	...
	protected function getListQuery()
	{
		...
		if (!empty($searchWord))
		{
			...
			else
			{
				...
				$query = Chat_botHelpersBackend::buildSearchQuery($searchWord, $searchColumns, $query);
			}
		}
