...
class Chat_botViewBot extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->params 				= $app->getParams('com_chat_bot');
        ...
        {
            $authorised = $user->authorise('core.create', 'com_chat_bot');
    ...
    protected function _prepareDocument()
    {
        ...
        {
            $this->params->def('page_heading', JText::_('COM_CHAT_BOT_DEFAULT_PAGE_TITLE'));
        }
