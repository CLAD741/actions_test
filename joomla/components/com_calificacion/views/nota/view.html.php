...
class CalificacionViewNota extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->params 				= $app->getParams('com_calificacion');
        ...
        {
            $authorised = $user->authorise('core.create', 'com_calificacion');
    ...
    protected function _prepareDocument()
    {
        ...
        {
            $this->params->def('page_heading', JText::_('COM_CALIFICACION_DEFAULT_PAGE_TITLE'));
        }
